      ...
      <header className="border-b border-slate-200 bg-white sticky top-0 z-10">
        <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-xl text-slate-900 tracking-tight">KOLFlow</span>
          </div>
          <nav>
            {isAuth ? (
              <Link
          ...
          <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div className="flex-1 w-full max-w-lg lg:max-w-none animate-fade-in-up" style={{ animationDelay: '100ms' }}>
              <div className="bg-white rounded-2xl border border-slate-200 shadow-2xl p-6 relative overflow-hidden">
                ...
                <div className="absolute top-20 right-4 bg-white px-3 py-1.5 rounded-full shadow-lg border border-slate-100 flex items-center gap-2 animate-bounce">
                  <div className="w-2 h-2 rounded-full bg-emerald-500" />
                  <span className="text-xs font-semibold text-slate-700">Campaign Active</span>
                </div>
              </div>
            </div>
          </div>
