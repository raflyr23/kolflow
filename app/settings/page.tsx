    ...
    <DashboardLayout>
      <div className="p-8 max-w-4xl mx-auto space-y-8 animate-fade-in-up">
        ...
        <section className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          ...
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-slate-500 mb-2">admin@kolflow.demo</p>
        ...
        <section className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-4 border border-red-100 rounded-lg bg-red-50/50 flex flex-col h-full">
              ...
              {showResetConfirm ? (
                <div className="space-y-3 p-3 bg-white border border-red-200 rounded-lg">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button 
                      ...
                      className="flex-1 px-3 py-1.5 bg-slate-100 text-slate-700 rounded text-sm font-medium hover:bg-slate-200 transition-colors"
                    >
                      Cancel
                    </button>
                  </div>
                ...
                <button 
                  ...
                  className="self-start px-4 py-2 bg-white border border-red-200 text-red-600 rounded-lg hover:bg-red-50 transition-colors text-sm font-medium shadow-sm"
                >
                  Reset Workspace
                </button>
              )}
              ...
              <div key={i} className="flex items-center justify-between p-3 rounded-lg hover:bg-slate-50 border border-transparent hover:border-slate-100 transition-colors">
                ...
                <div className="flex gap-1">
                  {shortcut.keys.map((k, j) => (
                    <kbd key={j} className="px-2 py-1 bg-slate-100 border border-slate-200 rounded text-xs font-mono text-slate-600 shadow-sm">
                      {k}
                    </kbd>
                  ))}
                </div>
        ...
        <section className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm text-center">
          ...
          <p className="text-sm text-slate-500 mb-4">Version 2.0.0</p>
          <div className="flex items-center justify-center gap-3 text-xs font-medium mb-6">
            <span className="px-2 py-1 rounded-md bg-slate-100 text-slate-700">Next.js 16</span>
            <span className="px-2 py-1 rounded-md bg-slate-100 text-slate-700">React 19</span>
